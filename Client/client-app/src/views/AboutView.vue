  ...
  <div class="global container">
      ...
      <div class="Materias-general">
        <div class="info">
          ...
          <span>Da clic en la materia para cargarla o eliminarla</span>
        </div>
        <div class="info">
          <h4>Materias Seleccionadas</h4>
        </div>
      </div>
      <MateriasDisplay :materiasSemestre="materiasSemestre" @materias-cursando="getMateriasCursando"/>
...
import { Alumno, MateriaVM, MateriasAlumno } from "@/utilities/ViewModels";
import MateriasDisplay from '@/components/MateriasDisplay.vue'
...
components:{
  ...
  data(){
    return{
      horas: [      // Array con las horas de 6:00 a 21:00
  ...
  computed: {
    selectVariant(index: number): string {
      let i = index;
